...
export default async function handler(req){
  ...
  if(!visualId||!['A','B','C','SELECTED','CORRECTED','MASTER_AVATAR','MASTER_PORTRAIT','MASTER_FULL','MASTER_SHEET'].includes(slot)){
  ...
  else if(slot==='MASTER_SHEET')key=job.master_sheet?.asset_key||null;
  else{
