(function(root){
  ...
  function todayItem(todo={}){
    return {
      ...
      concept_skill_target:todo.concept_skill_target||null,
      divisible_boundary:todo.divisible_boundary||null,
      confidence:Number.isFinite(todo.confidence)?todo.confidence:null,
      unresolved_flags:Array.isArray(todo.unresolved_flags)?[...todo.unresolved_flags]:[],
      state:todo.state,
      source:todo.source,
