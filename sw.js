const CACHE='ready-set-v094-rev07-staging27-realtime-m4a-recording-v1';
const CORE=[
...
'./ready-role-context-v1.js','./ready-onboarding-flow-completion-v1.js','./ready-foundation-v1.js','./ready-foundation-control-v1.js','./ready-stage-c-base.js','./ready-stage-d.js','./ready-stage-d-base-v1.js','./ready-recording-v1.js','./ready-stage-e.js','./ready-stage-f.js','./ready-parent-capture-intake-v1.js','./ready-homework-analysis-bridge-v1.js','./ready-stage-g1-fix.js','./ready-stage-g13-authority-recovery.js','./ready-stage-g14-planner-authority.js','./ready-base-native-v2.js','./ready-planner-selection-bridge-v1.js','./ready-schedule-base-v1.js','./ready-parent-setup-hub-v1.js','./ready-base-selftest-v1.js',
'./Ready_Set_Ui_Master_Logic_REV_06.md','./Ready_Set_Ui_Master_Logic_REV_07.md',
'./assets/icon-192.png','./assets/icon-512.png','./assets/guide-lumi.png','./assets/guide-pico.png','./assets/guide-mori.png','./assets/bgm-piano.wav','./assets/bgm-nature.wav','./assets/bgm-water.wav'
];
