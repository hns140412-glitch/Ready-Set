const CACHE='ready-set-v093-rev07-sync-v01';
const CORE=[
'./','./index.html','./styles.css','./ready-sync-adapter-v01.js','./ready-local-first-v01.js','./ready-planner-v01.js','./app.js','./ready-runtime-v07.js','./manifest.webmanifest','./VERSION.json',
