...
assert(['SOURCE_REFERENCE_ONLY_NOT_YET_RUNTIME_BINARY','POSE_BINARY_MATERIALIZATION_OPEN__CANONICAL_FALLBACK_ACTIVE','RUNTIME_SPRITE_BOUND_V1','BOUND_REPOSITORY_EMBEDDED_WEBP_SPRITE_2X6'].includes(poseBank.runtime_binding_state),'POSE_BANK_SOURCE_STATE_INVALID');
