(function(root,factory){
  ...
  const RULES={
    '국어':[
      ...
      {domain:'듣기·말하기',concept:'듣기·말하기 상호작용',terms:['발표','말하기','듣기','토의','토론','면담','질문','설명하기']},
      {domain:'문법',concept:'언어 형식과 표현',terms:['문법','맞춤법','어휘','낱말','문장 구조']},
    ...
    '수학':[
      ...
      {domain:'도형과 측정',concept:'도형·길이·넓이·각·측정',terms:['도형','각도','넓이','둘레','부피','길이','측정','삼각형','사각형','원']},
