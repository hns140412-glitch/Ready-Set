(function(root,factory){
  ...
  const RECORDS=[
    ...
    {code:'6수01-01',subject:'수학',domain:'수와 연산',semantic_summary:'사칙 혼합 계산의 순서를 이해하고 계산하기',keywords:['혼합 계산','덧셈','뺄셈','곱셈','나눗셈','계산 순서'],source:'GOE_2026_EVAL'},
    {code:'6수01-02',subject:'수학',domain:'수와 연산',semantic_summary:'이상·이하·초과·미만과 수의 범위 활용하기',keywords:['이상','이하','초과','미만','수의 범위'],source:'GOE_2026_EVAL'},
    {code:'6수01-03',subject:'수학',domain:'수와 연산',semantic_summary:'올림·버림·반올림의 의미와 실생활 활용 이해하기',keywords:['어림','올림','버림','반올림'],source:'GOE_2026_EVAL'},
    {code:'6수01-04',subject:'수학',domain:'수와 연산',semantic_summary:'약수·공약수·최대공약수 이해하고 구하기',keywords:['약수','공약수','최대공약수'],source:'GOE_2026_EVAL'},
    {code:'6수01-05',subject:'수학',domain:'수와 연산',semantic_summary:'배수·공배수·최소공배수 이해하고 구하기',keywords:['배수','공배수','최소공배수'],source:'GOE_2026_EVAL'},
    {code:'6수01-06',subject:'수학',domain:'수와 연산',semantic_summary:'크기가 같은 분수와 약분·통분 이해하기',keywords:['분수','약분','통분','크기가 같은 분수'],source:'GOE_2026_EVAL'},
    {code:'6수01-07',subject:'수학',domain:'수와 연산',semantic_summary:'분모가 다른 분수의 크기 비교하고 설명하기',keywords:['분모','분수','크기 비교'],source:'GOE_2026_EVAL'},
    {code:'6수01-08',subject:'수학',domain:'수와 연산',semantic_summary:'분모가 다른 분수의 덧셈·뺄셈 원리와 계산',keywords:['분수','덧셈','뺄셈','분모'],source:'GOE_2026_EVAL'},
    {code:'6수01-09',subject:'수학',domain:'수와 연산',semantic_summary:'분수 곱셈의 원리를 탐구하고 계산하기',keywords:['분수','곱셈','계산 원리'],source:'GOE_2026_EVAL'},
    {code:'6수01-10',subject:'수학',domain:'수와 연산',semantic_summary:'자연수 나눗셈의 몫을 분수로 나타내기',keywords:['자연수','나눗셈','몫','분수'],source:'GOE_2026_EVAL'},
    {code:'6수01-11',subject:'수학',domain:'수와 연산',semantic_summary:'분수 나눗셈의 원리를 탐구하고 계산하기',keywords:['분수','나눗셈','계산 원리'],source:'GOE_2026_EVAL'},
    {code:'6수01-12',subject:'수학',domain:'수와 연산',semantic_summary:'분수와 소수의 관계를 이해하고 크기 비교하기',keywords:['분수','소수','관계','크기 비교'],source:'GOE_2026_EVAL'},
    {code:'6수01-13',subject:'수학',domain:'수와 연산',semantic_summary:'소수 곱셈의 원리를 탐구하고 계산하기',keywords:['소수','곱셈','계산 원리'],source:'GOE_2026_EVAL'},
    {code:'6수01-14',subject:'수학',domain:'수와 연산',semantic_summary:'자연수 나눗셈의 몫을 분수로 나타내기',keywords:['자연수','나눗셈','몫','분수'],source:'GOE_2026_EVAL'},
    {code:'6수01-15',subject:'수학',domain:'수와 연산',semantic_summary:'소수 나눗셈의 원리를 탐구하고 계산하기',keywords:['소수','나눗셈','계산 원리'],source:'GOE_2026_EVAL'},
    {code:'6수02-01',subject:'수학',domain:'변화와 관계',semantic_summary:'대응 관계 표에서 규칙을 찾고 기호를 사용해 식으로 나타내기',keywords:['대응 관계','표','규칙','식'],source:'GOE_2026_EVAL'},
    {code:'6수02-02',subject:'수학',domain:'변화와 관계',semantic_summary:'두 양의 비교를 통해 비의 개념 이해하기',keywords:['비','두 양','비교','관계'],source:'GOE_2026_EVAL'},
    {code:'6수02-03',subject:'수학',domain:'변화와 관계',semantic_summary:'비율을 이해하고 분수·소수·백분율로 나타내기',keywords:['비율','분수','소수','백분율'],source:'GOE_2026_EVAL'},
    {code:'6수02-04',subject:'수학',domain:'변화와 관계',semantic_summary:'비례식과 성질을 이해하고 간단한 비례식 풀기',keywords:['비례식','성질','비례'],source:'GOE_2026_EVAL'},
    {code:'6수02-05',subject:'수학',domain:'변화와 관계',semantic_summary:'비례배분을 이해하고 주어진 양을 비례배분하기',keywords:['비례배분','비례','배분'],source:'GOE_2026_EVAL'},
    {code:'6수03-01',subject:'수학',domain:'도형과 측정',semantic_summary:'도형의 합동과 합동인 도형의 성질 탐구하기',keywords:['합동','도형','성질'],source:'GOE_2026_EVAL'},
    {code:'6수03-02',subject:'수학',domain:'도형과 측정',semantic_summary:'선대칭도형과 점대칭도형을 이해하고 그리기',keywords:['선대칭','점대칭','대칭도형'],source:'GOE_2026_EVAL'},
    {code:'6수03-03',subject:'수학',domain:'도형과 측정',semantic_summary:'직육면체와 정육면체의 구성 요소와 성질 이해하기',keywords:['직육면체','정육면체','구성 요소','성질'],source:'GOE_2026_EVAL'},
    {code:'6수03-04',subject:'수학',domain:'도형과 측정',semantic_summary:'직육면체와 정육면체의 겨냥도 그리기',keywords:['직육면체','정육면체','겨냥도'],source:'GOE_2026_EVAL'},
    {code:'6수03-05',subject:'수학',domain:'도형과 측정',semantic_summary:'각기둥과 각뿔의 구성 요소와 성질 이해하기',keywords:['각기둥','각뿔','구성 요소','성질'],source:'GOE_2026_EVAL'},
    {code:'6수03-06',subject:'수학',domain:'도형과 측정',semantic_summary:'각기둥의 전개도 그리기',keywords:['각기둥','전개도'],source:'GOE_2026_EVAL'},
    {code:'6수03-07',subject:'수학',domain:'도형과 측정',semantic_summary:'원기둥·원뿔·구의 구성 요소와 성질 이해하기',keywords:['원기둥','원뿔','구','구성 요소','성질'],source:'GOE_2026_EVAL'},
    {code:'6수03-08',subject:'수학',domain:'도형과 측정',semantic_summary:'원기둥의 전개도 그리기',keywords:['원기둥','전개도'],source:'GOE_2026_EVAL'},
    {code:'6수03-09',subject:'수학',domain:'도형과 측정',semantic_summary:'쌓기나무 입체도형의 사용 개수 구하기',keywords:['쌓기나무','입체도형','개수'],source:'GOE_2026_EVAL'},
    {code:'6수03-10',subject:'수학',domain:'도형과 측정',semantic_summary:'쌓기나무 입체도형을 여러 표현으로 나타내고 모양 추측하기',keywords:['쌓기나무','입체도형','위','앞','옆','모양'],source:'GOE_2026_EVAL'},
    {code:'6수03-11',subject:'수학',domain:'도형과 측정',semantic_summary:'평면도형 둘레 이해하고 구하기',keywords:['평면도형','둘레'],source:'GOE_2026_EVAL'},
    {code:'6수03-12',subject:'수학',domain:'도형과 측정',semantic_summary:'넓이 단위와 단위 사이 관계 이해하기',keywords:['넓이','제곱센티미터','제곱미터','제곱킬로미터','단위'],source:'GOE_2026_EVAL'},
    {code:'6수03-13',subject:'수학',domain:'도형과 측정',semantic_summary:'직사각형·정사각형 넓이 공식 이해하고 구하기',keywords:['직사각형','정사각형','넓이'],source:'GOE_2026_EVAL'},
    {code:'6수03-14',subject:'수학',domain:'도형과 측정',semantic_summary:'평행사변형·삼각형·사다리꼴·마름모 넓이 구하기와 추론',keywords:['평행사변형','삼각형','사다리꼴','마름모','넓이'],source:'GOE_2026_EVAL'},
    {code:'6수03-15',subject:'수학',domain:'도형과 측정',semantic_summary:'원주율의 의미를 이해하고 근삿값 활용하기',keywords:['원','원주','지름','원주율','근삿값'],source:'GOE_2026_EVAL'},
    {code:'6수03-16',subject:'수학',domain:'도형과 측정',semantic_summary:'원주와 원의 넓이를 구하는 방법 이해하고 계산하기',keywords:['원주','원의 넓이','원'],source:'GOE_2026_EVAL'},
    {code:'6수03-17',subject:'수학',domain:'도형과 측정',semantic_summary:'직육면체·정육면체 겉넓이 구하기',keywords:['직육면체','정육면체','겉넓이'],source:'GOE_2026_EVAL'},
    {code:'6수03-18',subject:'수학',domain:'도형과 측정',semantic_summary:'부피 단위와 단위 사이 관계 이해하기',keywords:['부피','세제곱센티미터','세제곱미터','단위'],source:'GOE_2026_EVAL'},
    {code:'6수03-19',subject:'수학',domain:'도형과 측정',semantic_summary:'직육면체·정육면체 부피 구하기',keywords:['직육면체','정육면체','부피'],source:'GOE_2026_EVAL'},
    {code:'6수04-02',subject:'수학',domain:'자료와 가능성',semantic_summary:'띠그래프·원그래프로 자료 나타내고 해석하기',keywords:['띠그래프','원그래프','자료','해석'],source:'GOE_2026_EVAL'},
    {code:'6수04-03',subject:'수학',domain:'자료와 가능성',semantic_summary:'탐구 문제에 맞는 자료를 수집·정리해 그래프로 나타내고 해석하기',keywords:['탐구 문제','자료 수집','정리','그래프','해석'],source:'GOE_2026_EVAL'},
    {code:'6수04-04',subject:'수학',domain:'자료와 가능성',semantic_summary:'사건이 일어날 가능성을 말로 표현하고 비교하기',keywords:['사건','가능성','표현','비교'],source:'GOE_2026_EVAL'},
    {code:'6수04-05',subject:'수학',domain:'자료와 가능성',semantic_summary:'사건의 가능성을 수로 나타내기',keywords:['사건','가능성','수'],source:'GOE_2026_EVAL'},
    {code:'6수04-06',subject:'수학',domain:'자료와 가능성',semantic_summary:'자료를 활용해 가능성을 예상하고 근거를 들어 판단하기',keywords:['자료','가능성','예상','근거','판단'],source:'GOE_2026_EVAL'},
