...
test('integration modules load in browser order',async({page})=>{
  ...
  const loaded=await page.evaluate(()=>({
    ...
    assignments:!!window.ReadyAssignments,subjectMaster:!!window.ReadySubjectMasterV01,standardMatcher:!!window.ReadyLearningStandardMatcherV01,learningReference:!!window.ReadyLearningReferenceV01,learning:!!window.ReadyLearningMasterV01,
