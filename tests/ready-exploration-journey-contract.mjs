...
const checks = [
  ...
  ['BGM sources are wired', base.includes("./assets/bgm-piano.wav") && base.includes("./assets/bgm-nature.wav") && base.includes("./assets/bgm-water.wav")],
  ['noisy lofi option removed', !base.includes("name:'로파이'")],
