...
const checks = [
  ...
  ['share card uses only truthful result fields', base.includes("status||readyOutcomeLabel(record?.status)") && base.includes("focusMs??record?.focusMs") && base.includes("targetMs??record?.targetMs")],
