...
if (!fixtures.includes(fixture) || !viewports[viewportName]) throw new Error('Use a documented fixture and mobile|desktop');
let chromium;
...
try {
  ...
  await fs.writeFile(new URL(`${id}.capture.json`, output), JSON.stringify({fixture,
    viewport:viewports[viewportName], dpr:1, locale:'ko-KR', timezone:'Asia/Seoul',
